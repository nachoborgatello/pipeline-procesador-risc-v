...
REM
REM Generated by Vivado on Mon May 18 18:21:09 -0300 2026
...
echo "xvlog --incr --relax -prj tb_debug_unit_vlog.prj"
call xvlog  --incr --relax -prj tb_debug_unit_vlog.prj -log xvlog.log
